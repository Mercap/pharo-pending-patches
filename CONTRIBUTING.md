...
You can report issues [here](https://github.com/Mercap/pharo-pending-patches/issues/new)
...
6. Do the changes
8. Commit and push your changes to the branch using the Iceberg UI
9. Create a Pull Request against the `release-candidate` branch
